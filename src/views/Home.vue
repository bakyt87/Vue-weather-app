<template>
  <div id="home">
   ...
   <div class="form-group">
     <br>
      <label class="card_data" for="city_name">Enter city name</label>
      <br>
  ...
  <div class="card-header"> <h4 style="color: white;">Current weather in</h4>
  <h4 class="card_data">{{forecast.data[0].city_name}} {{forecast.data[0].country_code}}</h4>
    
    <!-- <img src='http://openweathermap.org/img/wn/@2x.png'> -->
    <h4 class="card_data">{{forecast.data[0].weather.description}}</h4>
      <br>
      <h1 class="card_data">{{forecast.data[0].temp}} C</h1>
      <br>
